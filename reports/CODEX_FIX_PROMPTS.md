...
| **P2** | Claude (cheapest, fresh) | `reports/codex_prompts/P2_fresh_claude_hook_test.md` | **DONE** | `FRESH_SESSION_HOOKS_PASS`; gates `GOV-HOOK-001=RESOLVED` |
| **P3** | Codex 4.4 Light | `reports/codex_prompts/P3_codex44_base_closure.md` | **DONE (this closure)** | canonical lock + release guards + ledger + tests; `reports/base_closure/BC01–BC06` |

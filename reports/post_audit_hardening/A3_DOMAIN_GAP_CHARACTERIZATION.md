...
Date: 2026-08-15 · Executor: Claude Opus 4.8 · Verdict: **DG_CHARACTERIZED_GREEN (core + aggregator)**
...
`curvature_gap.compute` on real/synthetic XODR pairs (identical → gap≈0; single perturbation → right metric moves

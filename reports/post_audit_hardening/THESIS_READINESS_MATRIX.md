...
| R4 | Perceptual diff + perception generalization | ⚠️ strengthen / toolchain-blocked | semantic labels real; GNN and core domain-gap math characterized; both maps still need cook/capture | real-data run + cook both maps | toolchain/runtime |

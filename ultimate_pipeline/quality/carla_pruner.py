...
class CarlaSafetyPruner:
    ...
    def _index_roads(self, root: ET.Element) -> Dict[str, ET.Element]:
        roads = {}
    ...
    def _index_lane_nodes(self, roads_by_id: Dict[str, ET.Element]) -> Dict[LaneKey, LaneNode]:
    ...
    def _first_lane_section_index(self, road: ET.Element) -> Optional[int]:
        lss = _lane_sections_sorted(road)
        return 0 if lss else None

    def _last_lane_section_index(self, road: ET.Element) -> Optional[int]:
        lss = _lane_sections_sorted(road)
    ...
    def _prune_empty_lane_sections(self, root: ET.Element, roads_by_id: Dict[str, ET.Element]) -> int:
        removed = 0
        parent_map = _find_parent_map(root)
    ...
    def _prune_empty_roads(self, root: ET.Element, roads_by_id: Dict[str, ET.Element]) -> int:
        removed = 0
        for rid, road in list(roads_by_id.items()):
    ...
    def _cleanup_junctions(self, root: ET.Element, roads_by_id: Dict[str, ET.Element]) -> Tuple[int, int]:
        """

...
class DomainGapAggregator:
    ...
    def aggregate(
            *,
            ...
            gap_elevation: Dict | None = None,
            gap_intersection: Dict | None = None,
            gap_semantic: Dict | None = None,
            gap_road_classification: Dict | None = None,
            gap_connectivity: Dict | None = None,
        ...
        # =====================================================
        # Elevation (supplementary, reported but excluded)
        # =====================================================
        e = DomainGapAggregator._safe_dict(gap_elevation)
        if e and not e.get("disabled"):
            out["components"]["elevation"] = dict(e)
        else:
            out["components"]["elevation"] = {"disabled": True}
        ...
        # =====================================================
        # Connectivity (lane/junction fidelity)
        # =====================================================
        cn = DomainGapAggregator._safe_dict(gap_connectivity)
        if cn and not cn.get("disabled"):
            out["components"]["connectivity"] = dict(cn)
        else:
            out["components"]["connectivity"] = {"disabled": True}

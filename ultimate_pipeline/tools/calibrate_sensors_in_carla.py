...
def spawn_ego(world: carla.World, bp_filter: str = "vehicle.tesla.model3", spawn_index: int = 0) -> Actor:
...
def attach_camera(world: carla.World, ego: carla.Actor, cam: CameraModel, T_v_c: List[List[float]]) -> Actor:
...
def attach_lidar(world: carla.World, ego: carla.Actor, T_v_l: List[List[float]]) -> Actor:

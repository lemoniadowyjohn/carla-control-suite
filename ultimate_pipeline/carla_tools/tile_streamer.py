...
# Import-safety: imported by pipeline/tests even without CARLA.
try:  # pragma: no cover
    ...
    def __init__(
        ...
        if not _CARLA_AVAILABLE:
            raise RuntimeError(
                ...
                "Install/activate CARLA PythonAPI before using TileStreamer."
            )
        self.client = client

...
"""
Clean unified SETTINGS module for the Ultimate OSMâ†’CARLA Pipeline.
...
class Settings:
    ...
    ENABLE_OSM_DOWNLOAD: bool = True  # ðŸ” master switch
    ...
    # -----------------------------------------------------------------
    # OSM â†’ XODR generation (optional, thesis experiments)
    # -----------------------------------------------------------------
    # By default the pipeline starts from an existing INPUT_XODR.
    # Enable this if you want the repo itself to call an OSMâ†’XODR tool.
    GENERATE_XODR_FROM_OSM: bool = False
    # Optional explicit path to an OSMâ†’XODR converter (script or binary).
    ...
    # Traffic light â†’ lane validation
    ...
    ALLOW_FULL_LOAD_IN_STEP_10 = False  # ðŸ‘ˆ turn ON when you want to try full load
    ...
    STRICT_TILE_SEMANTICS = (
        False  # crash vs mark â€œCrash if any tile has roads but no driving lanesâ€
    )

    TILE_AUTO_FORENSICS_TRIGGER_N = 3  # observation threshold

    # ===============================
    # STEP 10 â€” TILE QA METRICS
    # ===============================
    ...
    # --------------------------------------------------
    # STEP 10 â€” CARLA / TILE QA
    # --------------------------------------------------
    # --------------------------------------------------
    #  âš ï¸â€” TILING SEMANTICS POLICY
    # --------------------------------------------------
    ...
    # ============================================================
    # 13B) DOMAIN GAP â†’ TILE HEATMAPS
    # ============================================================
    ...
    # ============================================================
    # DOMAIN GAP â€“ LEARNED / GNN-BASED (OPTIONAL EXTENSION)
    # ============================================================
    ...
    # If True â†’ HARD FAIL when torch_geometric is missing
    # If False â†’ skip gracefully (recommended)
    ...
    # ============================================================
    # DOMAIN GAP â€“ ENABLE / ABLATION SWITCHES
    # ============================================================
    ...
    # ============================================================
    # DOMAIN GAP â€“ NORMALIZATION REFERENCES (EXPLICIT CONTRACT)
    # ============================================================

    DOMAIN_GAP_NORMALIZATION = {
        # Geometry
        "geometry_rmse_m": 1.0,  # 1 m RMSE â‰ˆ strong geometric deviation
        "hausdorff_m": 5.0,
        # Curvature
        "curvature_kl": 0.5,
    ...
    # ============================================================
    # DOMAIN GAP â€“ COMPOSITE WEIGHTS (AGGREGATION)
    # ============================================================
    ...
    # ============================================================
    # DOMAIN GAP â€“ SWEEP CONFIGURATION (HPC / STATISTICS)
    # ============================================================
    ...
    # ============================================================
    # GEOMETRY GAP â€“ PERFORMANCE / ABLATION
    # ============================================================
    ...
    def domain_gap_dir(self) -> str:
        # âœ… minimal dedup: use configured output dir name
    ...
    def __post_init__(self):
        ...
        if (
            ...
            _boot_log(
                "[WARN] Tiling enabled without guaranteed lane semantics â€” tiles may be non-drivable by design."
            )
        ...
        # 3. DO NOT create output_dir() here â€" that would generate a new
    ...
    # =====================================================
    CARLA_SAFE_MODE = False  # ðŸš¨ master kill-switch

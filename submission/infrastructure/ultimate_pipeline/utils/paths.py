...
def cities_root() -> Path:
    """Base directory for cities.

    Order of resolution:
    1) UP_CITIES_DIR (repo-relative allowed)
    2) <repo>/ultimate_pipeline/cities (preferred when repo stores cities under the package)
    3) <repo>/cities (legacy layout)
    """

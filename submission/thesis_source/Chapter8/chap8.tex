...
\hline
A contrastive GNN trained on the structural metrics produced a non-collapsed latent space (observational). & Any downstream accuracy, transfer, or generalisation claim. \\
\hline
\end{tabular}

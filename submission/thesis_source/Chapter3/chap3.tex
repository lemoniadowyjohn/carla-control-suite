...
textbf{Note on run configurations:} The auto road count (5{,}837) and junction count (779) are anchored to the RQ2 governed run (run_11). The RQ1 determinism audit uses a different pipeline configuration and reports 5{,}712 roads (see Table~ef{tab:determinism_results}); both counts are internally consistent within their respective research-question contexts.

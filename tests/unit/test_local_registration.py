...
def test_local_structural_summary_reports_ratios_and_excludes_construction():
    ...
    gap = SimpleNamespace(lane_width_gap=0.0415, curvature_gap=0.2239, building_density_gap=0.31)
    ...
    # traffic lights remain excluded (Grid0828 does not model them at all)
